                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="profile.php"
                                aria-expanded="false">
                                <i class="fa fa-columns" aria-hidden="true"></i>
                                <span class="hide-menu">Company registered<table></table></span>
                            </a>
                        </li>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                ...
                                $place="SELECT * FROM `tbl_cmpreg` WHERE `status`='1'";
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0"> Remove the Company</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           <td> <?php echo $id=$row['id'];?></td>
                                            ...
                                            <?php echo'<a href="reject.php?id='.$id.'">     <button class="btn btn-danger">Dismiss the company</button></a>';?>
                                            </td>
                                            <td>
